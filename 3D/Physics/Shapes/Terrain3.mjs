...
var Terrain3 = class extends Composite {
    ...
    setMesh(options, THREE) {
        var material = options?.material ?? new THREE.MeshPhongMaterial({ color: 0x00ff00 });
        ...
        this.setColorGeometry(topGeo, THREE);

        var botGeo = new THREE.PlaneGeometry(this.terrainWidth, this.terrainDepth, this.heightmaps.widthSegments, this.heightmaps.depthSegments);
        botGeo.rotateX(-Math.PI / 2);
        this.calculateMeshVertices(botGeo, this.heightmaps.bottom);
        this.setColorGeometry(botGeo, THREE);

        var leftGeo = new THREE.PlaneGeometry(this.terrainWidth, 1, this.heightmaps.widthSegments, 1);
        ...
        this.setColorGeometry(leftGeo, THREE);

        var rightGeo = new THREE.PlaneGeometry(this.terrainWidth, 1, this.heightmaps.widthSegments, 1);
        ...
        this.setColorGeometry(rightGeo, THREE);

        var forwardGeo = new THREE.PlaneGeometry(this.terrainDepth, 1, this.heightmaps.depthSegments, 1);
        ...
        this.setColorGeometry(forwardGeo, THREE );

        var backGeo = new THREE.PlaneGeometry(this.terrainDepth, 1, this.heightmaps.depthSegments, 1);
        ...
        this.setColorGeometry(backGeo, THREE);
        ...
        botMaterial.side = THREE.BackSide;
        ...
        forwardMaterial.side = THREE.BackSide;
        var backMaterial = material.clone();


        var topMesh = new THREE.Mesh(topGeo, topMaterial);
        var botMesh = new THREE.Mesh(botGeo, botMaterial);
        var leftMesh = new THREE.Mesh(leftGeo, leftMaterial);
        var rightMesh = new THREE.Mesh(rightGeo, rightMaterial);
        var forwardMesh = new THREE.Mesh(forwardGeo, forwardMaterial);
        var backMesh = new THREE.Mesh(backGeo, backMaterial);
